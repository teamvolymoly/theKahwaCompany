  ...
  return (
    <main className="bg-[#fdfefb] pt-[88px] text-[#252a23]">
      <section className="site-container pb-20 pt-12 md:pt-20">
        ...
        <div className="mt-8 min-h-[365px] rounded-lg bg-[#f1f4ec] p-4 md:mt-11 md:p-6">
          <AccountNav appearance="panel" />
          {/* <h2 className="mt-6 rounded-lg bg-[#fdfefb] p-6 font-basker text-xl uppercase md:w-1/2">Orders</h2> */}
          <details className="mt-5">
            <summary className="w-fit cursor-pointer text-sm text-[#52653b] underline underline-offset-4">
              Filter orders
            </summary>
            <div className="mt-10 rounded-lg border border-[#dfe5d8] bg-[#f3f6ef] p-6">
              <div className="flex flex-col gap-4 xl:flex-row xl:items-end lg:justify-between">
                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4 lg:gap-4">
                  <div>
                    <label className="text-md normal-case tracking-normal text-black/50">
                      Status
                    </label>
                    <select
                      value={status}
                ...
                <button
                  ...
                  className="rounded-sm border border-black/40 px-4 py-2 text-xs font-semibold normal-case tracking-normal text-black hover:border-black"
                >
                  Reset filters
                </button>
              </div>
          ...
          <div className="mt-5 rounded-lg bg-[#fdfefb] p-6">
            <div className="flex items-center justify-between">
              <p className="text-md normal-case tracking-normal text-black/60">
                All orders
              </p>
